...
namespace Core.Interfaces.Repositories
{
    public interface IInscricaoRepository : IRepository<Inscricao>
    {
        ...
        Task<Inscricao?> GetInscricaoByCampeonatoAndUsuarioAsync(int campeonatoId, string usuarioId, CancellationToken cancellationToken);
        Task<bool> TimeInscritoCampeonatoAsync(int campeonatoId, int timeId, CancellationToken cancellationToken);
        Task<bool> UsuarioInscritoSoloCampeonatoAsync(int campeonatoId, string usuarioId, CancellationToken cancellationToken);
        ...
        Task<int> GetTotalInscritoSoloCampeonatoAsync(int campeonatoId, CancellationToken cancellationToken);
